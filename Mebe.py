...
def strecken_einfügen():
    ...
    while stopp != 'e':
        ...
        try:
            ...
            print('Strecke existiert noch nicht!')
            Versuch=1
        ...
        if Versuch==1:
            ...
            print('Es wird eine neue Strecke angelegt!')
            
            streckeneigenschaften=[]
            
            streckeneigenschaften.append(input('Wer fuhr die Rekordzeit?'))
            streckeneigenschaften.append(int(input('Welcher Streckentyp (zwischen 1 und 3)? Je höher, desto schneller ist die Strecke.')))
            streckeneigenschaften.append(int(input('Wie hoch ist die Schwierigkeit (zwischen 1 und 10)?')))
        ...
        stopp=input('Eine weitere Strecke hinzufügen? Wenn nicht, dann drücke "e"!')
...
def fahrer_einfügen():
    ...
    while stopp != 'e':
        ...
        Pilotenname=input('Name des Piloten? Denke an den Namenszusatz, wenn Du sein Profil mit einer Meisterschaft verknüpft hast!')
        ...
        try:
            ...
            print('Fahrer existiert noch nicht!')
            Versuch=1
        ...
        if Versuch==1:
            ...
            print('Es wird ein neues Fahrerprofil angelegt!')
            
            fahrereigenschaften=[]
            
            fahrereigenschaften.append(int(input('In welchem Jahr wurde der Pilot geboren?')))
            fahrereigenschaften.append(int(input('In welchem Jahr fuhr der Fahrer das erste Mal?')))
            fahrereigenschaften.append(int(input('Wie aggressiv fährt der Pilot (Wert zw. 1 und 10)? Je höher, desto aggressiver.')))
            fahrereigenschaften.append(int(input('Wie geschickt fährt der Fahrer (Wert zw. 1 und 10)? Je höher, desto geschickter.')))
            fahrereigenschaften.append(int(input('Wie hoch ist das Grundkönnen des Fahrers (Wert zw. 1 und 100 im Vergleich zum besten Fahrer nach eigener Einschätzung)? Je höher, desto besser.')))
            z=(int(input('Hat der Fahrer eine Vorliebe für schnelle Strecken? Wenn ja, drücke "2"')))
            if z != 2:
                z=1
            fahrereigenschaften.append(z)
            fahrereigenschaften.append(int(input('Wie ist die Durchschnittliche Platzierung des Fahrers? Achtung, Ganzzahlen!')))
            fahrereigenschaften.append(input('Mit welchem Fahrzeug fährt der Fahrer?')) #auswählen lassen???
            fahrereigenschaften.append(int(input('Seit welchem Jahr fährt er sein Fahrzeug (wenn er die Jahre zuvor mit derselben Marke gefahren ist, zählt es dazu)?')))
        ...
        stopp=input('Einen weiteren Piloten hinzufügen? Wenn nicht, dann drücke "e"!')
...
def fahrzeuge_einfügen():
    ...
    while stopp != 'e':
        ...
        pfad=input('Name des Fahrzeugs? Hast Du keine Typbezeichnung, nutze den Markennamen und die Meisterschaft als Name.')
        pfad += '.dat'
        ...
        try:
            ...
            print('Fahrzeug existiert noch nicht!')
            Versuch=1
        ...
        if Versuch==1:
            ...
            print('Es wird ein neues Fahrzeug angelegt!')
            
            fahrzeugeigenschaften=[]
            
            fahrzeugeigenschaften.append(int(input('Wie ist die Leistung im Vergleich zu den anderen Fahrzeugen (zw. 1 bis 3)? Je höher, desto besser.')))
            fahrzeugeigenschaften.append(int(input('Wie ist die Wendigkeit im Vergleich zu den anderen Fahrzeugen (zw. 1 bis 3)? Je höher, desto besser.')))
        ...
        stopp=input('Ein weiteres Fahrzeug hinzufügen? Wenn nicht, dann drücke "e"!')
...
def strecke_berechnen(streckendaten_moment, fahrerdaten): #, fahrzeugdaten):
    ...
    for i in range(0, len(fahrerdaten)):
        ...
        if zufallszahl1==1 and (streckendaten_moment[1]*fahrerdaten_aktuell[2]*streckendaten_moment[2])-Grunderfahrung>190:
            Unfall=-70
        else:
            Unfall=0
...
''')
    ...
    for i in range(0, len(streckendaten)):
        ...
        while prüfung==0:
            try:
                rennpfad='Datenbank/Meisterschaften/' + str(eingabe) + str(prüfziffer) + 'Rennergebnisse' + streckendaten[i].replace('Datenbank/Strecken/', '')
                #pfad wird erstellt
                f=open(rennpfad, 'rb')
    ...
    while prüfung==0:
        try:
            speicherpfad='Datenbank/Meisterschaften/' + str(eingabe) + str(prüfziffer) + 'Meisterschaftsergebnisse' + '.dat'
            #pfad wird erstellt
...
def erstellen():
    ...
    meisterschaftspfad=input('Wie soll die Meisterschaft heißen? Schreibe ggf. auch die Jahreszahl dazu!')
...
''')
    ...
    if auswahl.lower()=='s':
        ...
        #pfad='Datenbank/'
        print('Work in Process! Diese Funktion ist in weiteren Updates geplant, bitte habe Geduld...')
        Menü()
    ...
    eingabe_neu=input('Wenn Du den Index des Wertes weißt, dann gebe ihn an. Ansonsten tippe (w)eiter.')
    ...
    if platzhalter==1:
        ...
        print('Eine Neudefinition ist nötig.')
        ...
        if auswahl=='s': #wird sich erinnert, was geändert werden soll. Dann werden die Daten einfach überschrieben
            ...
            if z != 2:
                z=1
            fahrereigenschaften.append(z)
            fahrereigenschaften.append(int(input('Wie ist die Durchschnittliche Platzierung des Fahrers?')))
            fahrereigenschaften.append(input('Mit welchem Fahrzeug fährt der Fahrer?'))
            fahrereigenschaften.append(int(input('Seit welchem Jahr fährt er sein Fahrzeug (wenn er die Jahre zuvor mit derselben Marke gefahren ist, zählt es dazu)?')))
            fahrereigenschaften.append(Pilotenname)
        ...
        neuerWert=input('Wie ist der neue Wert der zu verändernden Stelle?')
        eingabe_neu=int(eingabe_neu)
        daten[eingabe_neu]=neuerWert #daten wird an vorhin eingegebener Stelle verändert, wie es in neuerWert eingegeben wurde
...
def Menü():
    ...
    auswahl=int(input('Was soll durchgeführt werden?'))
    
    if auswahl==1:
        berechnen()
    elif auswahl==2:
        print('Diese Option ist derzeit nicht verfügbar!')
        Menü()
    elif auswahl==3:
        erstellen()
    elif auswahl==4:
...
Mebe V1.0.0''')
        ...
        print('Eine falsche Auswahl wurde angegeben!')
        Menü()
